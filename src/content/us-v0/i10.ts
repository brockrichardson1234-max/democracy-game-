...
export const US_V0_I10_COMPOSITION_SEMANTICS_VERSION = "us-v0-full-causal-vertical-1";
...
const compositionWithoutHash = {
  ...
  recordIds: {
    programConstraintPrefix: "us.program-constraint.judicial-order.",
    relationshipExecutionPrefix: "us.relationship-qualification-execution.",
  },
};
