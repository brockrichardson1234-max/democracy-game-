...
**USCFG-ERR-001 — Senate class cycle.** This narrow post-acceptance configuration correction replaces the contract's incorrect assignment of the **2029-01-03** ordinary Senate turnover to Class I. The corrected cycle is **2027 = Class II, 2029 = Class III, 2031 = Class I**, as stated by the official U.S. Senate [Class I](https://www.senate.gov/senators/Class_I.htm), [Class II](https://www.senate.gov/senators/Class_II.htm), and [Class III](https://www.senate.gov/senators/Class_III.htm) records. This erratum changes neither Architecture V0 nor I1, does not reopen the research program, and adds no configuration scope.
...
At **2029-01-03 12:00 America/New_York**, the same ordered rules apply except only Senate Class III assignments turn over; Class I and Class II normal assignments persist. Class I normal assignments persist through this January 2029 boundary; their ordinary term boundary is **2031-01-03**. The entire House turns over again. This transition completes before the **2029-01-06** presidential electoral count, and that count references the newly constituted Congress and its active assignments.
...
5. **2029-01-03 12:00 America/New_York:** the congressional transition in Section 9.3 completes, including all House and only Senate Class III assignments, political-organization rebuild, and pending-procedure expiry.
...
8. **Succession and term-boundary persistence.** Direct advance and save/load across 2027-01-03 and 2029-01-03 produce identical assignments: the whole House and only Class II then Class III Senate assignments turn over at those respective boundaries, no expired actor retains authority, organization state rebuilds, pending bills expire, and the 2029-01-06 count uses the new Congress. Class I normal assignments persist through January 2029 and reach their ordinary boundary on 2031-01-03. At January 20, presidential assignments/binding change while projects, fiscal records, laws, reports, Population/Housing state, and unrelated transitions retain identity/history.
